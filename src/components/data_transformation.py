...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            # Remove the extra list brackets here
            ...
            cat_pipeline = Pipeline(
                steps=[
                    ...
                    ("scaler", StandardScaler(with_mean=False))  # Added with_mean=False for sparse data
                ]
            )

            logging.info("Numerical columns: {numerical_columns}")
            logging.info("Categorical columns: {categorical_columns}")
            logging.info("Numerical pipeline creation completed")
